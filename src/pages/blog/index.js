                  ...
                  <div className="widget-body">
                    <ul className="widget-list">
                      {blogConfig.categories.map(category =>
                        <li key={`/category/${kebabCase(category.text)}/`}><Link to={`/category/${kebabCase(category.text)}/`}>{category.text}</Link></li>)}
                    </ul>
                  </div>
                </li>
                <li className="widget item-no-bullet">
                  ...
                  <div className="widget-body">
                    <ul className="widget-list">
                      {blogConfig.connect.map(link =>
                        <li key={link.link}><a href={link.link} target="_blank" rel="noopener noreferrer">{link.text}</a></li>)}
                    </ul>
                  </div>
                </li>
              </ul>
